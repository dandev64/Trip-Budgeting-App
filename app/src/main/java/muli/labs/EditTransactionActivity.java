...
public class EditTransactionActivity extends AppCompatActivity {
    ...
    private void loadTransactionDetails() {
        ...
        if (transaction != null) {
            transactionNameInput.setText(transaction.getName());
            totalBillInput.setText(String.valueOf(transaction.getTotalBill()));
            ...
            for (Contributor contributor : transaction.getContributors()) {
                ...
                if (friend != null) {
                    ...
                    contributionInput.setText(String.valueOf(contributor.getContributedAmount()));
                    owedInput.setText(String.valueOf(contributor.getAmountOwed()));
                    contributionInput.setVisibility(View.VISIBLE);
                    owedInput.setVisibility(View.VISIBLE);
                }
    ...
    private void loadContributors() {
        ...
        for (Friend friend : friends) {
            ...
            for (View friendView : friendViews) {
                CheckBox friendCheckBox = friendView.findViewById(R.id.friendCheckBox);
                if (friendCheckBox.getText().toString().equals(friend.getName())) {
                    alreadyExists = true;
                    break;
                }
            }
    ...
    private void saveTransaction() {
        ...
        realm.executeTransactionAsync(realm -> {
            ...
            if (transaction != null) {
                ...
                transaction.getContributors().deleteAllFromRealm();
